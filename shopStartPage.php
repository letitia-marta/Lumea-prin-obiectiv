    ...
    <body>
        ...
        <section id="product1" class="section-p1">
            <div class="pro-container">
                <div class="pro">
                    <img src="photos/utilitare/tablou.jpg" alt="">
                    <div class="des">
                        <?php echo '<a href="shopTablouri.php">';?><h5>Tablouri</h5>
                    </div>
                </div>

                <div class="pro">
                    <img src="photos/utilitare/poster.jpg" alt="">
                    <div class="des">
                        <?php echo '<a href="shopPostere.php">';?><h5>Postere</h5>
                    </div>
                </div>

                <div class="pro">
                    <img src="photos/utilitare/obiecte.jpg" alt="">
                    <div class="des">
                        <?php echo '<a href="shopObiecte.php">';?><h5>Obiecte decorative</h5>
                    </div>
                </div>
            </div>
        </section>
