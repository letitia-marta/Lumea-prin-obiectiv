                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="authcode.php" method="POST">
                            ...
                            <button style="font-size: 14px;font-weight: 600;padding: 15px 30px;color: #ffffff;background-color: #088178;border-radius: 4px;cursor: pointer;border: none;outline: none;transition: 0.2s;" type="submit" name="buton_inregistrare">Inregistreaza-te</button>
                        </form>
                    </div>
                </div>
            </div>
